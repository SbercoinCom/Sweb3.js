...
class Sweb3 {
   ...
   * @param {number} blocks How many blocks are generated immediately.
   * @param {string} address The address to send the newly generated sbercoin to.
   * @param {number} maxTries How many iterations to try (default = 1000000).
   * @return {array} Hashes of blocks generated.
   */
  ...
  /** ******** RAW TRANSACTIONS ********* */
  /**
   * Get the hex address of a Sbercoin.com address.
   * @param {string} address Sbercoin.com address
  ...
  /**
   * Converts a hex address to Sbercoin.com address.
   * @param {string} hexAddress Sbercoin.com address in hex format.
   * @return {Promise} Sbercoin.com address or Error.
   */
  ...
  /** ******** UTIL ********* */
  /**
   * Validates if a valid Sbercoin.com address.
   * @param {string} address Sbercoin.com address to validate.
   ...
   * @param {string} address The Sbercoin.com address for the private key.
  ...
  /**
   * Encrypts the wallet for the first time. This will shut down the Sbercoin.com server.
  ...
  /**
   * Gets the account name associated with the Sbercoin.com address.
   * @param {string} address The Sbercoin.com address for account lookup.
  ...
  /**
   * Gets the Sbercoin.com address based on the account name.
  ...
  /**
   * Gets the Sbercoin.com address with the account name.
   * @param {string} acctName The account name ("" for default).
   * @return {Promise} Sbercoin.com address array or Error.
   */
  ...
  /**
   * Gets a new Sbercoin.com address for receiving payments.
   ...
   * @return {Promise} Array of addresses with Sbercoin.com balances or Error.
   */
  ...
  /**
   * Lists unspent transaction outputs.
   * @param {string} address Address to send Sbercoin.com to.
   * @param {number} amount Amount of SBER to send.
   ...
   * @param {string} senderAddress The Sbercoin.com address that will be used to send money from.
   ...
   * @param {bumber} amount The transaction fee in SBER/kB.
