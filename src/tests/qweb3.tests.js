...
describe('Sweb3', () => {
  ...
  beforeEach(() => {
    sweb3 = new Sweb3(getQtumRPCAddress());
  });
  ...
  describe('getHexAddress()', () => {
    it('returns the hex address', async () => {
      ...
      const hexadecimalAddress = await sweb3.getHexAddress(QTUM_ADDRESS);
  ...
  describe('fromHexAddress()', () => {
    it('returns the qtum address', async () => {
      const qtumAddress = await sweb3.fromHexAddress('17e7888aa7412a735f336d2f6d784caefabb6fa3');
  ...
  describe('validateAddress()', () => {
    it('returns an object validating the address', async () => {
      let res = await sweb3.validateAddress(QTUM_ADDRESS);
      assert.isDefined(res);
