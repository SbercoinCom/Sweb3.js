...
class Encoder {
  ...
  /**
   * Converts a Sbercoin.com or hex address to a padded hex string.
   * @param {string} address The Sbercoin.com/hex address to convert.
  ...
  static constructData(abi, methodName, args = []) {
    ...
    return funcHash + dataHexArr.join('') + hexStringArgs.join('');
  }
}
